            ...
            <div className="flex justify-center md:block">
              <Link href={PATHROUTES.CART}>
                <span className="relative text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-300">
                  ...
                  <span className="bg-blue-500 rounded-full absolute -top-[80%] -right-[60%] aspect-[1/1] w-full h-full flex justify-center items-center text-white text-[12px] font-light">
                    {cartItemCount}
                  </span>
                </span>
              </Link>
